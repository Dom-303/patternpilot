...
```
---
slug: server-side-rendering-for-event-detail-pages-with-pocketbase-backend              ← use this exact value
title: Server-side rendering for event detail pages with PocketBase backend              ← use this exact value
status: active
project: eventbear-web              ← use this exact value
created_at: 2026-04-25          ← use this exact value
---
