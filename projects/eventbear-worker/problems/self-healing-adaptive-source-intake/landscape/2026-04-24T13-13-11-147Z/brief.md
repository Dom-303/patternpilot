...
run_id: 2026-04-24T13-13-11-147Z
project: eventbear-worker
generated_at: 2026-04-24T13:13:11.152Z
...
|---|---|---|---|---|
| automation+playwright+query:selector-self-healing | needs_manual_read | query:selector-self-healing, e2e-testing, playwright | https://github.com/alexandriashai/cbrowser, https://github.com/lvortexl/aws-test-framework-boilerplate, https://github.com/TheFishPilot/Verity-Agentic-Web-Scraper | adjacent |
...
| based+query:dom-template-matching+query:wrapper-induction | needs_manual_read | query:dom-template-matching, query:wrapper-induction, based | https://github.com/ecenazg/Template-matching-and-image-filtering-in-frequency-domain, https://github.com/hjleed/Face-Recognition-System-Based-on-Template-Matching-in-Frequency-Domain, https://github.com/mehardsingh/scholarly-entity-wrapper-induction | divergent |
