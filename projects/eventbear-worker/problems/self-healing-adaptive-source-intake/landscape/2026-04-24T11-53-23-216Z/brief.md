...
run_id: 2026-04-24T11-53-23-216Z
project: eventbear-worker
generated_at: 2026-04-24T11:53:23.220Z
...
|---|---|---|---|---|
| automation+query:adaptive-xpath+query:selector-self-healing | needs_manual_read | query:selector-self-healing, automation, query:adaptive-xpath | https://github.com/alexandriashai/cbrowser, https://github.com/lvortexl/aws-test-framework-boilerplate, https://github.com/D4Vinci/Scrapling | adjacent |

## Empfehlungs-Signale (Heuristik)
- highest_problem_fit_cluster: automation+query:adaptive-xpath+query:selector-self-healing
- constraint_clean_cluster: automation+query:adaptive-xpath+query:selector-self-healing
