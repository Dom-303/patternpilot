...
run_id: 2026-04-22T18-09-18-779Z
project: eventbear-worker
generated_at: 2026-04-22T18:09:18.781Z
...
|---|---|---|---|---|
| mcp+playwright+typescript | needs_manual_read | typescript, mcp, playwright | https://github.com/alexandriashai/cbrowser, https://github.com/lvortexl/aws-test-framework-boilerplate, https://github.com/D4Vinci/Scrapling | adjacent |

## Empfehlungs-Signale (Heuristik)
- highest_problem_fit_cluster: mcp+playwright+typescript
- constraint_clean_cluster: mcp+playwright+typescript
