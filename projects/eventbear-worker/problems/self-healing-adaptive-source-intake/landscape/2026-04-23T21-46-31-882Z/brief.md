...
run_id: 2026-04-23T21-46-31-882Z
project: eventbear-worker
generated_at: 2026-04-23T21:46:31.896Z
...
|---|---|---|---|---|
| automation+data+selectors | needs_manual_read | automation, selectors, data | https://github.com/alexandriashai/cbrowser, https://github.com/lvortexl/aws-test-framework-boilerplate, https://github.com/D4Vinci/Scrapling | adjacent |

## Empfehlungs-Signale (Heuristik)
- highest_problem_fit_cluster: automation+data+selectors
- constraint_clean_cluster: automation+data+selectors
