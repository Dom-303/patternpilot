...
run_id: 2026-04-24T18-02-59-405Z
project: eventbear-worker
generated_at: 2026-04-24T18:02:59.418Z
...
|---|---|---|---|---|
| download+python+query:structured-data-extractor | needs_manual_read | query:structured-data-extractor, download, now | https://github.com/yarnfieldiscool/resumeX, https://github.com/anasgg2/mathfactlab-blog-scraper, https://github.com/conectrix/structify | divergent |
...
- highest_problem_fit_cluster: download+python+query:structured-data-extractor
- constraint_clean_cluster: download+python+query:structured-data-extractor
- anti_tunnel_alternative: download+python+query:structured-data-extractor
