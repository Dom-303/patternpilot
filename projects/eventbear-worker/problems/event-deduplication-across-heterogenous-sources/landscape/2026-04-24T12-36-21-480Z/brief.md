...
run_id: 2026-04-24T12-36-21-480Z
project: eventbear-worker
generated_at: 2026-04-24T12:36:21.484Z
...
| 20build+python+query:fuzzy-string-matching | needs_manual_read | query:fuzzy-string-matching, 20build, actions | https://github.com/rapidfuzz/RapidFuzz, https://github.com/Ashu9372/medicine-chatbot, https://github.com/nym21/quickmatch | divergent |
| feature+fellegi-sunter+implementation | needs_manual_read | feature, fellegi-sunter, implementation | https://github.com/Tox1469/string-similarity, https://github.com/dylantmoore/splink_stata | divergent |
...
- anti_tunnel_alternative: 20build+python+query:fuzzy-string-matching
