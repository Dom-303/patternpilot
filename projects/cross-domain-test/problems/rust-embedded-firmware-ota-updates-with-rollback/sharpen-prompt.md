...
```
---
slug: rust-embedded-firmware-ota-updates-with-rollback              ← use this exact value
title: Rust embedded firmware OTA updates with rollback              ← use this exact value
status: active
project: cross-domain-test              ← use this exact value
