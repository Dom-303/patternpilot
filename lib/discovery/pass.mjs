  ...
  for (const phrase of queries) {
    try {
      const result = await searchFn(
        ...
        // perPage: 20 — verdoppelt den Pool pro Query. Wichtig, damit Stage-0-
        // Provenance-Clustering genug Mitglieder pro Query-Linse findet, um
        // einen echten Cluster zu bilden (>= 3 Mitglieder pro Provenance).
        { perPage: 20 }
      );
