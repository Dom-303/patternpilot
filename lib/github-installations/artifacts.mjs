...
export async function writeGithubAppInstallationServiceScheduleArtifacts(rootDir, options) {
  return writePlanArtifacts(rootDir, "github-app-installation-service-schedule", {
    plan: "service-schedule-plan.json",
    receipts: "service-schedule-receipts.json",
    state: "service-schedule-state.json"
  }, options);
}
