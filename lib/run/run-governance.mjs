...
import { describeGovernanceOperatingPosture } from "../automation/operating-mode.mjs";
...
function withGovernancePosture(governance) {
  const posture = describeGovernanceOperatingPosture(governance);
  return {
    ...governance,
    operatingPosture: governance?.operatingPosture ?? posture.postureKey,
    operatorMode: governance?.operatorMode ?? posture.operatorMode,
    operatorSummary: governance?.operatorSummary ?? posture.summary
  };
}
...
- operating_posture: ${governance.operatingPosture ?? posture.postureKey}
- operator_mode: ${governance.operatorMode ?? posture.operatorMode}
...
- summary: ${governance.operatorSummary ?? posture.summary}
