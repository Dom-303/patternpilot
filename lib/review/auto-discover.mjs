...
export async function runAutoDiscoverForReview({
  ...
  const discoveryProfile = options.discoveryProfile ?? DEFAULT_DISCOVERY_PROFILE;
  const analysisDepth = options.analysisDepth ?? DEFAULT_ANALYSIS_DEPTH;
  const reportView = options.reportView ?? DEFAULT_REPORT_VIEW;
