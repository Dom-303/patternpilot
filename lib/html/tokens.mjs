...
.sidenav-list a {
  ...
  /* Mittelweg zwischen ganz kompakt und dem alten 12px-Padding. Passt
     bei 22 Items auf 800px+ Viewports ohne Scrollbar, bleibt aber gut
     lesbar und angenehm getroffen. */
  padding: 9px 14px;
  font-family: 'JetBrains Mono', monospace;
