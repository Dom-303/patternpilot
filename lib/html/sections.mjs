...
function renderDiscoveryRow(candidate) {
  ...
  const body = `<div class="repo-body">
    <div class="repo-body-grid">
      ...
      ${renderRepoBodyCell("Evidenz", evidenceText, { emptyReason: "Das Repo hat keine strukturierte Evidenz-Bewertung erhalten." })}
  ...
  <summary>
    ...
    <span class="badge ${badge.tone} badge--clickable"${buildBadgeExplainAttrs(badge.tone)}>${escapeHtml(badge.label)}</span>
