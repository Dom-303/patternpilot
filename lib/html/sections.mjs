  ...
  const grid = renderInfoGrid([
    {
      ...
      emptyText: "Keine Dateien gelesen. Grund: Fuer dieses Ziel-Repository sind keine Kontextdateien in der Bindung konfiguriert."
    },
    {
    ...
    },
    {
      ...
      emptyText: "Keine Signale abgeleitet. Grund: Aus dem aktuellen Kontext konnten keine strukturierten Projekt-Faehigkeiten extrahiert werden."
    }
  ], { variant: "halves" });
...
export function renderReportToolbar({ modeOptions, layerOptions }) {
  ...
  <div class="toolbar-body">
    ...
    <label class="toolbar-toggle" for="show-empty-sections-toggle">
      <input type="checkbox" id="show-empty-sections-toggle">
      <span class="toolbar-toggle-label">Auch leere Felder anzeigen</span>
    </label>
    <p class="toolbar-inline-help">Default: nur gefuellte Sektionen werden gezeigt. Schalter umlegen fuer alle 27 Sektionen.</p>
    ${renderFilterIndicator()}
  </div>
</section>`;
}
