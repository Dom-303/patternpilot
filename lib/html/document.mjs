...
import { INFO_DIALOG_SCRIPT, AGENT_SNAPSHOT_SCRIPT, renderInfoDialog } from "./components.mjs";
...
export function renderHtmlDocument({
  ...
  // Empfehlungen sind ab jetzt konsolidiert in EINER Section mit Tabs,
  // die Caller (html-renderer.mjs oder Smoke) via sections[] einschleusen.
  // Die frueheren zwei Panels "Erste Empfehlungen" + "Empfohlene Aktionen"
  // entfallen hier hardcoded.
...
/* Agent-snapshot styles — zentralisiert in COCKPIT_NIGHT_BASE_CSS (tokens.mjs),
   damit Landscape- und Main-Report dieselbe Darstellung bekommen. */
