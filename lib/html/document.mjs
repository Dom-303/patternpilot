...
function renderReportContentIntro({ reportType, projectKey, createdAt, heroSubtitle, candidateCount, runRoot }) {
  ...
  const introInfo = getSectionInfo("report-intro");
  const actionsFragment = introInfo
    ? `<details class="section-description section-description--dark section-description--intro">
  <summary><span class="section-description-label">Beschreibung</span></summary>
  <div class="section-description-body"><p>${escapeHtml(introInfo.body)}</p></div>
</details>`
    : "";
...
export function renderHtmlDocument({
  ...
  const recommendationsPanel = `<section class="section-preview accent-magenta" id="recommendations" data-nav-section>
