...
export function renderHtmlDocument({
  ...
  const statsPanel = `<section class="panel-card stats-strip" id="stats">
      ...
      <p class="panel-copy">Die kompakten Kennzahlen fuer den ersten Blick, bevor du tiefer in Karten, Matrix oder Regelwerk gehst.</p>
...
@media (max-width: 720px) {
  ...
  .report-overview { grid-template-columns: 1fr; gap: 20px; }
...
(() => {
  ...
  const infoMap = {
    ...
    "erste empfehlungen": "Erste Empfehlungen beantwortet nicht die Gesamtlage, sondern deine Startreihenfolge. Patternpilot sortiert hier die naechsten sinnvollen Schritte so, dass du mit moeglichst wenig Lesen schnell in die wertvollsten Kandidaten oder Aktionen kommst. Wenn du nur drei Minuten hast, arbeite genau diesen Block von oben nach unten durch.",
    "erste empfehlung": "Erste Empfehlungen beantwortet nicht die Gesamtlage, sondern deine Startreihenfolge. Patternpilot sortiert hier die naechsten sinnvollen Schritte so, dass du mit moeglichst wenig Lesen schnell in die wertvollsten Kandidaten oder Aktionen kommst. Wenn du nur drei Minuten hast, arbeite genau diesen Block von oben nach unten durch.",
    "recommendations": "Erste Empfehlungen beantwortet nicht die Gesamtlage, sondern deine Startreihenfolge. Patternpilot sortiert hier die naechsten sinnvollen Schritte so, dass du mit moeglichst wenig Lesen schnell in die wertvollsten Kandidaten oder Aktionen kommst. Wenn du nur drei Minuten hast, arbeite genau diesen Block von oben nach unten durch.",
    ...
    "staerkste vergleichs-repos": "Staerkste Vergleichs-Repos ist der eigentliche Arbeitskern des Berichts. In diesen Karten zeigt Patternpilot pro Repo die Passung, den vermuteten Nutzen, die relevante Ebene und die naechste sinnvolle Bewegung fuer dein Zielprojekt. Wenn du konkrete Vorbilder uebernehmen, vergleichen oder bewusst verwerfen willst, triffst du diese Entscheidungen hier.",
    "staerkste vergleich repos": "Staerkste Vergleichs-Repos ist der eigentliche Arbeitskern des Berichts. In diesen Karten zeigt Patternpilot pro Repo die Passung, den vermuteten Nutzen, die relevante Ebene und die naechste sinnvolle Bewegung fuer dein Zielprojekt. Wenn du konkrete Vorbilder uebernehmen, vergleichen oder bewusst verwerfen willst, triffst du diese Entscheidungen hier.",
    "top-compared-repositories": "Staerkste Vergleichs-Repos ist der eigentliche Arbeitskern des Berichts. In diesen Karten zeigt Patternpilot pro Repo die Passung, den vermuteten Nutzen, die relevante Ebene und die naechste sinnvolle Bewegung fuer dein Zielprojekt. Wenn du konkrete Vorbilder uebernehmen, vergleichen oder bewusst verwerfen willst, triffst du diese Entscheidungen hier.",
    ...
    "umfang des laufs": "Umfang des Laufs erklaert, aus welchem Material dieser Bericht gebaut wurde. Du siehst hier, ob Patternpilot nur einige explizit uebergebene Repos bewertet hat oder ob zusaetzlich Watchlist-, Queue- oder weitere Kontextquellen eingeflossen sind. Genau das bestimmt, wie breit oder wie eng du die Aussagen des Berichts lesen solltest.",
    "run-scope": "Umfang des Laufs erklaert, aus welchem Material dieser Bericht gebaut wurde. Du siehst hier, ob Patternpilot nur einige explizit uebergebene Repos bewertet hat oder ob zusaetzlich Watchlist-, Queue- oder weitere Kontextquellen eingeflossen sind. Genau das bestimmt, wie breit oder wie eng du die Aussagen des Berichts lesen solltest.",
    ...
    "staerkste risikosignale": "Staerkste Risikosignale sammelt die staerksten Gruende gegen eine vorschnelle Uebernahme. Dieser Bereich ist nicht dazu da, gute Treffer schlechtzureden, sondern um dir zu zeigen, wo technische Unsicherheit, fehlende Daten oder Richtungsbruch zuerst manuell geklaert werden muessen. Lies diese Liste wie eine bewusste Warnspur vor der Umsetzung.",
    "highest-risk-signals": "Staerkste Risikosignale sammelt die staerksten Gruende gegen eine vorschnelle Uebernahme. Dieser Bereich ist nicht dazu da, gute Treffer schlechtzureden, sondern um dir zu zeigen, wo technische Unsicherheit, fehlende Daten oder Richtungsbruch zuerst manuell geklaert werden muessen. Lies diese Liste wie eine bewusste Warnspur vor der Umsetzung.",
    ...
    "fehlendes intake fuer auswahl": "Fehlendes Intake fuer Auswahl zeigt dir nicht einfach ein leeres Datenloch, sondern eine ganz konkrete Bewertungsgrenze dieses Laufs. Wenn hier Repos auftauchen, sind sie fuer Patternpilot bereits sichtbar oder interessant, aber noch nicht mit frischem Intake unterfuettert. Solange das offen ist, solltest du diese Repos eher vorbereiten als schon produktseitig uebernehmen.",
    "missing-watchlist-intake": "Fehlendes Intake fuer Auswahl zeigt dir nicht einfach ein leeres Datenloch, sondern eine ganz konkrete Bewertungsgrenze dieses Laufs. Wenn hier Repos auftauchen, sind sie fuer Patternpilot bereits sichtbar oder interessant, aber noch nicht mit frischem Intake unterfuettert. Solange das offen ist, solltest du diese Repos eher vorbereiten als schon produktseitig uebernehmen.",
  ...
  const getInfoText = (label, sectionId = "") => {
    ...
    return infoMap[sectionKey] || infoMap[labelKey] || "Kurzinfo: Dieses Feld erklaert, wie Patternpilot diese Stelle im Bericht einordnet.";
  };
