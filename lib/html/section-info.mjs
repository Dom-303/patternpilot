...
export const SECTION_INFO_MAP = {
  ...
  "kandidaten-kombiniert": {
    title: "Kandidaten",
    body: "Diese Section buendelt die beiden Kandidaten-Sichten in einer Section mit Tabs. Tab 1 'Discovery-Kandidaten' zeigt Repos, die Pattern Pilot in diesem Lauf neu entdeckt hat — via GitHub-Suche gegen den Projektkontext. Tab 2 'Vergleichs-Repos' zeigt Repos aus deiner Watchlist im Review-Vergleich gegen das Zielprojekt. Beide nutzen dieselbe Repo-Row-Struktur mit Deep-Content-Expand."
  },
  "candidate-overview": {
  ...
  "problem-details": {
    ...
    body: "Hier steht der ausformulierte Problem-Kontext: Beschreibung, aktueller Ansatz, Erfolgskriterien, Constraints und Nicht-Ziele. Alles aus der problem.md-Frontmatter. Diese Details sind der Lese-Anker fuer die Landscape — ohne sie ist die Kandidaten-Liste kontextlos."
  },
  "discovery-lenses": {
  ...
  "entscheidungen": {
    ...
    body: "Die Entscheidungen-Section buendelt drei Sichten in Tabs. Tab 1 'Top-Rang' zeigt die staerksten Repo-Empfehlungen aus allen Clustern, priorisiert nach Relation (divergent zuerst, weil hoechstes Lern-Potenzial). Tab 2 'Nach Relation gruppiert' zeigt die Cluster nach ihrer Beziehung zum Zielprojekt — divergent, benachbart, naher Ansatz. Tab 3 'Entscheidungs-Begruendung' gibt pro Top-Cluster Pro/Contra + Impact-Schaetzung."
  },
  "landscape-filter": {
    title: "Bericht filtern",
    body: "Filter-Werkzeug fuer groessere Landscapes. Der Empty-Toggle oben rechts zeigt standardmaessig nur Cluster und Sections mit echtem Inhalt — leere Sections (z.B. weil eine Relation keine Cluster hat) werden ausgeblendet. Umlegen fuer die volle Sicht."
  },
  "landscape-what-now": {
    title: "Was jetzt? — Action-Steps",
    body: "Vom Landscape-Report zur konkreten Handlung. Tab 1 'Kompakt' sind die drei dringendsten Schritte. Tab 2 'Ausfuehrlich' gibt pro Cluster-Typ (divergent/adjacent) einen erklaerenden Absatz was als naechstes tun. Tab 3 'Aktions-Checkliste' ist die abhakbare Todo-Liste mit Impact-Einschaetzung. Tab 4 'CLI-Befehle' zeigt die problem-mode-Commands zum Copy-paste."
  },
  "lauf": {
    title: "Lauf-Info",
