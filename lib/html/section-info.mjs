...
export const SECTION_INFO_MAP = {
  ...
  "coverage": {
    title: "Coverage",
    body: "Dieser Bereich macht sichtbar, welche Ebenen, Lueckenbereiche und Faehigkeiten der aktuelle Bericht tatsaechlich beruehrt. Die Achsen-Balken visualisieren, wie stark jede Dimension im Lauf vertreten ist — so erkennst du, ob der Lauf ausgewogen ist oder ob wichtige Themen unterbelichtet bleiben."
  },
  ...
  "target-repo-context": {
    ...
    body: "Der Zielrepo-Kontext zeigt, worauf Pattern Pilot alle Vergleiche bezieht. Dadurch werden Kandidaten nicht isoliert bewertet, sondern immer gegen die echten Dateien, Strukturen und Faehigkeiten des Zielprojekts gelesen."
  },
  "discovery-lenses": {
