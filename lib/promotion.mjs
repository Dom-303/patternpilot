...
function buildLearningCandidate(queueEntry, binding) {
  ...
  return {
    title: `${repoRef} als Signal fuer ${getProjectGapAreaGuess(queueEntry, "relevante Ausbauachsen")}`,
    observation:
    ...
    meaningForProject:
      getLearningForProject(queueEntry, "") ||
