...
import { evaluateDiscoveryCandidatePolicy } from "./discovery-policy.mjs";
...
const RETRYABLE_PATTERNS = [
  ...
  { category: "rate_limit", pattern: /rate limit|429|secondary rate limit/i, retryable: true, recommendedDelayMinutes: 30, exitCode: 75 },
