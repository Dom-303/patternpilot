...
- generated_at: 2026-04-25T21:29:44.472Z
...
- **[content] label-fidelity** — mean 0.83/2, min 0/2 (anwendbar in 6/6 Runs)
- **[content] problem-fit** — mean 1/2, min 0/2 (anwendbar in 6/6 Runs)
- **[structure] cluster-diversity** — mean 1.83/2, min 1/2 (anwendbar in 6/6 Runs)
- **[content] classification-confidence** — mean 1.83/2, min 1/2 (anwendbar in 6/6 Runs)
